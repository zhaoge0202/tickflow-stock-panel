...
def _fetch_minute_or_502(
    symbol: str, trade_date: date, asset_type: str = "stock", capset=None,
):
    try:
        return kline_sync.fetch_minute_single(
            symbol, trade_date, asset_type=asset_type, capset=capset,
        )
